     ...
     <nav class="navbar">
         <div class="container-fluid">
             <div class="navbar-header">
                 ...
                 <a class="navbar-brand" href="#">ระบบ STAR TO DC </a>
             </div>
                                         ...
                                         <?php
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) { ?>
                                                 <tr>
                                                     <td><?php echo $row['rdcId']  ?></td>
                                                     <td><?php echo $row['rdcCustomer']  ?></td>
                                                     <td><?php echo $row['rdcName']  ?></td>
                                                     <td><?php echo $row['rdcAddr']  ?></td>
                                                     <td><?php echo $row['rdcTel']  ?></td>
                                                     <td><?php echo $row['rdcFax']  ?></td>
                                                     <td><?php echo $row['rdcProvince']  ?></td>
                                                 </tr>
                                         <?php }
                                            } ?>
                                         <?php $conn->close(); ?>
