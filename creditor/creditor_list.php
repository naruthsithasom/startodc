    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">ระบบ START TO DC </a>
            </div>
                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                <tr>
                                    <td>2002000001</td>
                                    <td>นาย ก</td>
                                    <td><a href="javascript:(0)" data-toggle="modal" data-target="#showdocument">10</a></td>
                                    <td>เดี่ยว</td>
                                    <td>
                                        99 ถ.หลวง แขวงบึงกุ่ม เขตบางกะปิ กรุงเทพ 10210
                                    </td>
                                    <td><button onclick="window.location.href = 'creditor_add.php?menuname=creditor&menulv=creditor_add'" class="btn bg-orange waves-effect">แก้ไข</button></td>
                                    <td><button class="btn bg-blue waves-effect" data-toggle="modal" data-target="#showgroup">ดูสมาชิกในกลุ่ม</button></td>
                                    <td class="col-green font-bold">กำลังใช้งาน</td>
                                    <td><button class="btn bg-red waves-effect" data-toggle="modal" data-target="#savesuccess ">ยกเลิกบัญชี</button></td>
                                </tr>
                                <tr>
                                    <td>2002000002</td>
                                    <td>นาย ก,ข,ค</td>
                                    <td><a href="javascript:(0)" data-toggle="modal" data-target="#showdocument">5</a></td>
                                    <td>กลุ่ม</td>
                                    <td>
                                        99 ถ.หลวง แขวงบึงกุ่ม เขตบางกะปิ กรุงเทพ 10210
                                    </td>
